					...
					<div class="container pagina">
						<div class="row">
							<div class="col">
								<h4>Nova tarefa</h4>
								<hr />
								<!-- Nova parte adicionada no formulário para selecionar a categoria da tarefa -->
								<form method="post" action="tarefa_controller.php?acao=inserir">
									...
									<div class="form-group">
										...
										<input type="date" class="form-control" name="horario_lembrete">
									</div>
